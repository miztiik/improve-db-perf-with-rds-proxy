...
REPO_NAME="improve-db-perf-with-rds-proxy"
...
sudo yum -y install python3-pip jq unzip
sudo yum -y install python3-setuptools python3-devel postgresql-devel gcc
...
install_and_config_postgresql   | tee "${LOG_FILE}"
